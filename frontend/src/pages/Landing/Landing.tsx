  ...
  return (
    <div className={styles.page} ref={pageRef}>
      ...
      <header className={styles.header}>
        <Link to="/" className={styles.brand} aria-label="Endroll home">
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroCopy} data-reveal>
            ...
            <div className={styles.heroActions}>
              ...
              <Link to="/diary" className={styles.heroGhost}>
        ...
        <section id="archive" className={styles.archive}>
          <article className={styles.entry} data-reveal>
            ...
            <div className={styles.entryFoot}>
              ...
              <Link to="/diary" className={styles.entryLink}>
      ...
      <footer className={styles.footer}>
        ...
        <nav className={styles.footerLinks} aria-label="Footer">
          <Link to="/diary" className={styles.footerLink}>Privacy</Link>
          <Link to="/diary" className={styles.footerLink}>Terms</Link>
          <Link to="/diary" className={styles.footerLink}>Your data</Link>
